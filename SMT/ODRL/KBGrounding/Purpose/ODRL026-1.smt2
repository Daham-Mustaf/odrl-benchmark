; ODRL026-1.smt2 — isAllOf compatible: commResearch ⊑ R&D ∩ commPurpose
...
(assert (forall ((x Entity))
    (=> (and (subClassOf x researchAndDevelopment) (subClassOf x commercialPurpose) (taxonomic purpose))
        (in_denotation x c1))))
