...
%                                     AND purpose eq advertising
%            Spatial: bavaria ⊑ europe → compatible
%            Purpose: advertising ⊄ nonCommercialPurpose → conflict
%            Conjunction fails because purpose pair has empty intersection.
%            Tests cross-dataspace conservative semantics.
%--------------------------------------------------------------------------
...
% Expected to FAIL: spatial overlaps but purpose does not.

fof(odrl031_cross_compatible, conjecture,
