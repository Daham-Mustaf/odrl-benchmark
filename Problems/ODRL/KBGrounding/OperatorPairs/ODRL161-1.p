%--------------------------------------------------------------------------
% File     : ODRL161-1.p : TPTP-ODRL Benchmark
% Domain   : ODRL Policy Conflict Detection
% Problem  : isAllOf {R&D,comm} vs isNoneOf {comm}: Conflict
% Status   : Theorem
...
fof(c2_def, axiom,
    has_operand(c2,purpose) & has_operator(c2,isNoneOf) & has_value(c2,commercialPurpose)).
