%--------------------------------------------------------------------------
% File     : ODRL157-1.p : TPTP-ODRL Benchmark
% Domain   : ODRL Policy Conflict Detection
% Problem  : isAnyOf {de,en} vs isNoneOf {de,en}: contradiction
% Status   : Theorem
...
fof(c2_def, axiom,
    has_operand(c2,language) & has_operator(c2,isNoneOf) & has_value(c2,de) & has_value(c2,en)).
...
fof(c2_isNoneOf_if, axiom,
    ![X]: ((~subClassOf(X,de) & ~subClassOf(X,en) & taxonomic(language)) => in_denotation(X,c2))).
