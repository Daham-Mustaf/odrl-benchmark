%--------------------------------------------------------------------------
% File     : ODRL174-1.p : TPTP v0.1.0.
% Domain   : ODRL Policy Conflict Detection
% Problem  : N-Way Composed — 4-Policy Spoiler on One Dimension
% Expected : Theorem
% Verdict  : MixedNWay
% Paper    : N-Way Composed — 4-Policy Spoiler on One Dimension
%
...
%
% One-liner : 4-policy spoiler: spatial conflict on B,C only, purpose compatible
