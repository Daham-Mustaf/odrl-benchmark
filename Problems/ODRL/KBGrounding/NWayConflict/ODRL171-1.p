%--------------------------------------------------------------------------
% File     : ODRL171-1.p : TPTP v0.1.0.
% Domain   : ODRL Policy Conflict Detection
% Problem  : N-Way Composed — Non-Transitive on ONE Dimension
% Expected : Theorem
% Verdict  : NonTransitive
% Paper    : N-Way Composed — Non-Transitive on ONE Dimension
%
...
%
% One-liner : Non-transitive multi-dim: spatial conflict breaks transitivity
