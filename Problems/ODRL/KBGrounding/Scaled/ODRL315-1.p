...
fof(den1, axiom, ![X]: (inDen1(X) <=> (concept(X) & (X = c0 | X = c1 | X = c2 | X = c3 | X = c4 | X = c5 | X = c6 | X = c7 | X = c8 | X = c9 | X = c10 | X = c11 | X = c12 | X = c13 | X = c14 | X = c15 | X = c16 | X = c17 | X = c18 | X = c19 | X = c20 | X = c21 | X = c22 | X = c23 | X = c24 | X = c25 | X = c26 | X = c27 | X = c28 | X = c29)))).
fof(den2, axiom, ![X]: (inDen2(X) <=> (concept(X) & ~(X = c0 | X = c1 | X = c2 | X = c3 | X = c4 | X = c5 | X = c6 | X = c7 | X = c8 | X = c9 | X = c10 | X = c11 | X = c12 | X = c13 | X = c14)))).
