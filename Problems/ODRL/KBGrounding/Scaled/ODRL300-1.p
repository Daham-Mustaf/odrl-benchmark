...
fof(den1, axiom, ![X]: (inDen1(X) <=> (concept(X) & ~(subclass(X, c0) | subclass(X, c1) | subclass(X, c2) | subclass(X, c3) | subclass(X, c4) | subclass(X, c5) | subclass(X, c6) | subclass(X, c7) | subclass(X, c8) | subclass(X, c9))))).
fof(den2, axiom, ![X]: (inDen2(X) <=> (X = c10))).
