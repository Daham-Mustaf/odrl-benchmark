...
fof(closure, axiom, ![X]: (concept(X) => (X = c0 | X = c1 | X = c2 | X = c3 | X = c4 | X = c5 | X = c6 | X = c7 | X = c8 | X = c9 | X = c10 | X = c11 | X = c12 | X = c13 | X = c14 | X = c15 | X = c16 | X = c17 | X = c18 | X = c19 | X = root))).
fof(den1, axiom, ![X]: (inDen1(X) <=> (concept(X) & ~(subclass(X, c0) | subclass(X, c1) | subclass(X, c2) | subclass(X, c3) | subclass(X, c4) | subclass(X, c5) | subclass(X, c6) | subclass(X, c7) | subclass(X, c8) | subclass(X, c9) | subclass(X, c10) | subclass(X, c11) | subclass(X, c12) | subclass(X, c13) | subclass(X, c14) | subclass(X, c15) | subclass(X, c16) | subclass(X, c17) | subclass(X, c18) | subclass(X, c19)) & X != root))).
