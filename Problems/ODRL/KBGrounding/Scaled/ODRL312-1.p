...
fof(den1, axiom, ![X]: (inDen1(X) <=> (concept(X) & (X = c0 | X = c1 | X = c2 | X = c3 | X = c4)))).
fof(den2, axiom, ![X]: (inDen2(X) <=> (concept(X) & (X = c5 | X = c6 | X = c7 | X = c8 | X = c9)))).
