%--------------------------------------------------------------------------
% File     : ODRL213-1.p : TPTP v0.1.0.
% Domain   : ODRL Policy Conflict Detection
% Problem  : 3-Hop + N-Way + DAG — Cross-Dataspace Triple Policy
% Expected : Theorem
% Verdict  : Compatible
% Paper    : 3-Hop + N-Way + DAG — Cross-Dataspace Triple Policy
%
...
%
% One-liner : 3-hop + n-way + DAG: 3 policies across 4 dataspaces
% Difficulty: Extreme
