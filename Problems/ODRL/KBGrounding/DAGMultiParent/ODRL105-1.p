...
% Problem  : Note 1 — DAG Subsumption via Multi-Parent Path
% Expected : Theorem
% Verdict  : Subsumption
% Paper    : Note 1 — DAG Subsumption via Multi-Parent Path
%
...
%
% One-liner : DAG subsumption: cR ⊆ cP via multi-parent path
% Difficulty: Medium
