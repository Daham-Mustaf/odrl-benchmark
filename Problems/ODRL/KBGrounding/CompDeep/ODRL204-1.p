%--------------------------------------------------------------------------
% File     : ODRL204-1.p : TPTP-ODRL Benchmark
% Domain   : ODRL Policy Conflict Detection
% Problem  : XONE: two branches Compatible: Unknown
...
fof(c3_def, axiom,
    has_operand(c3,purpose) & has_operator(c3,eq) & has_value(c3,nonCommercialResearch)).
