...
% Problem  : N-Way Composed — 3-Policy Mutual Exclusion (Spatial Suffices)
% Expected : Theorem
% Verdict  : Conflict
% Paper    : N-Way Composed — 3-Policy Mutual Exclusion (Spatial Suffices)
%
...
%
% One-liner : 3-policy mutual exclusion: spatial conflict suffices (Thm 2)
