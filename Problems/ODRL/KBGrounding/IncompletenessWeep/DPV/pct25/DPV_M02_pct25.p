%--------------------------------------------------------------------------
% File     : DPV_M02_pct25.p : TPTP v0.1.0.
...
% DPV disjointness: 16/22 kept (25% removed)
...
% ─── Conjecture ──────────────────────────────────────────────────────────
fof(dpv_m02, conjecture, ?[X]: (in_denotation(X,commercialResearch,isA) & in_denotation(X,researchAndDevelopment,isA))).
