%--------------------------------------------------------------------------
% File     : LANG_M05_full.p : TPTP v0.1.0.
...
% LANG disjointness: 25/25 kept (0% removed)
...
fof(lang_disj_de_es, axiom, disjoint(deLang,esLang)).
fof(lang_disj_de_es_sym, axiom, disjoint(esLang,deLang)).
fof(lang_disj_fr_nl, axiom, disjoint(frLang,nlLang)).
fof(lang_disj_fr_nl_sym, axiom, disjoint(nlLang,frLang)).
fof(lang_disj_fr_es, axiom, disjoint(frLang,esLang)).
fof(lang_disj_fr_es_sym, axiom, disjoint(esLang,frLang)).
fof(lang_disj_nl_es, axiom, disjoint(nlLang,esLang)).
fof(lang_disj_nl_es_sym, axiom, disjoint(esLang,nlLang)).
fof(lang_disj_enGB_enUS, axiom, disjoint(enGB,enUS)).
fof(lang_disj_enGB_enUS_sym, axiom, disjoint(enUS,enGB)).
fof(lang_disj_enGB_enAU, axiom, disjoint(enGB,enAU)).
fof(lang_disj_enGB_enAU_sym, axiom, disjoint(enAU,enGB)).
fof(lang_disj_enUS_enAU, axiom, disjoint(enUS,enAU)).
fof(lang_disj_enUS_enAU_sym, axiom, disjoint(enAU,enUS)).
fof(lang_disj_deAT_deCH, axiom, disjoint(deAT,deCH)).
fof(lang_disj_deAT_deCH_sym, axiom, disjoint(deCH,deAT)).
fof(lang_disj_frCH_frBE, axiom, disjoint(frCH,frBE)).
fof(lang_disj_frCH_frBE_sym, axiom, disjoint(frBE,frCH)).
fof(lang_disj_enGB_de, axiom, disjoint(enGB,deLang)).
fof(lang_disj_enGB_de_sym, axiom, disjoint(deLang,enGB)).
fof(lang_disj_enUS_de, axiom, disjoint(enUS,deLang)).
fof(lang_disj_enUS_de_sym, axiom, disjoint(deLang,enUS)).
fof(lang_disj_enGB_fr, axiom, disjoint(enGB,frLang)).
fof(lang_disj_enGB_fr_sym, axiom, disjoint(frLang,enGB)).
fof(lang_disj_enUS_fr, axiom, disjoint(enUS,frLang)).
fof(lang_disj_enUS_fr_sym, axiom, disjoint(frLang,enUS)).
fof(lang_disj_deAT_en, axiom, disjoint(deAT,en)).
fof(lang_disj_deAT_en_sym, axiom, disjoint(en,deAT)).
fof(lang_disj_deCH_en, axiom, disjoint(deCH,en)).
fof(lang_disj_deCH_en_sym, axiom, disjoint(en,deCH)).
fof(lang_disj_frCH_en, axiom, disjoint(frCH,en)).
fof(lang_disj_frCH_en_sym, axiom, disjoint(en,frCH)).
fof(lang_disj_frBE_en, axiom, disjoint(frBE,en)).
fof(lang_disj_frBE_en_sym, axiom, disjoint(en,frBE)).
fof(lang_disj_frCH_de, axiom, disjoint(frCH,deLang)).
fof(lang_disj_frCH_de_sym, axiom, disjoint(deLang,frCH)).
fof(lang_disj_frBE_de, axiom, disjoint(frBE,deLang)).
fof(lang_disj_frBE_de_sym, axiom, disjoint(deLang,frBE)).

% ─── Conjecture ──────────────────────────────────────────────────────────
fof(lang_m05, conjecture, ?[X]: (in_denotation(X,enGB,isPartOf) & in_denotation(X,en,isPartOf) & in_denotation(X,allLanguages,isPartOf))).
