; ODRL027-1.smt2 — isAllOf Unknown: scientificResearch ⊄ R&D ∩ nonCommPurpose
...
(assert (forall ((x Entity))
    (=> (and (subClassOf x researchAndDevelopment) (subClassOf x nonCommercialPurpose) (taxonomic purpose))
        (in_denotation x c1))))
