...
% Policy pair: Permit location=bavaria vs Prohibit location=czechia
% Note: D3-derived: bav≤de≤wE, cz≤eE, wE⊥eE
...
% ─── Conjecture ─────────────────────────────────────────────────────────────
fof(e4_c1_04, conjecture, ![X]: ~(in_denotation(X,bavaria,isPartOf) & in_denotation(X,czechia,isPartOf))).
%--------------------------------------------------------------------------
