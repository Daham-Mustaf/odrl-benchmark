...
% Policy pair: Permit location=bavaria implies westernEurope allowed
% Note: compat: bav≤de≤wE universal
...
% ─── Conjecture ─────────────────────────────────────────────────────────────
fof(e4_c1_10, conjecture, ![X]: (in_denotation(X,bavaria,isPartOf) => in_denotation(X,westernEurope,isPartOf))).
%--------------------------------------------------------------------------
