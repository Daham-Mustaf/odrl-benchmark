...
% Policy pair: Permit location=bavaria vs Permit location=europe
% Note: compat: bav≤de≤wE≤eu — chain witness
...
% ─── Conjecture ─────────────────────────────────────────────────────────────
fof(e4_c1_07, conjecture, ?[X]: (in_denotation(X,bavaria,isPartOf) & in_denotation(X,europe,isPartOf))).
%--------------------------------------------------------------------------
