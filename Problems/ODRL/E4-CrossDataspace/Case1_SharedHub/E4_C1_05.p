...
% Policy pair: Permit location=italy vs Prohibit location=easternEurope
% Note: D2-derived: it≤wE, wE⊥eE
...
% ─── Conjecture ─────────────────────────────────────────────────────────────
fof(e4_c1_05, conjecture, ![X]: ~(in_denotation(X,italy,isPartOf) & in_denotation(X,easternEurope,isPartOf))).
%--------------------------------------------------------------------------
