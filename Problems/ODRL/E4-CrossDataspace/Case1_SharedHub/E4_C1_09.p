%--------------------------------------------------------------------------
% File     : E4_C1_09.p : TPTP v0.1.0
% Domain   : ODRL Policy Conflict Detection — E4 Cross-Dataspace
% Problem  : E4_C1_09
% Expected : Theorem
% Operator : isPartOf
% Case     : Case1-SharedHub: both parties use full GEO KB
% Date     : 2026-02-28
% Purpose  : E4 — Validate no false positives across dataspace boundaries
%--------------------------------------------------------------------------
include('Axioms/Layer1-ODRLCore/ODRL000-0.ax').
% Policy pair: Three-party chain: germany ∩ westernEurope ∩ europe
% Note: compat: 3-way chain de≤wE≤eu
% ─── Shared Hub KB (GEO, complete) ────────────────────────────────────
...
fof(geo_disj_pl_cz, axiom, disjoint(poland,czechia)).
fof(geo_disj_pl_cz_sym, axiom, disjoint(czechia,poland)).
fof(geo_disj_de_pl, axiom, disjoint(germany,poland)).
fof(geo_disj_de_pl_sym, axiom, disjoint(poland,germany)).
fof(geo_disj_de_cz, axiom, disjoint(germany,czechia)).
fof(geo_disj_de_cz_sym, axiom, disjoint(czechia,germany)).
fof(geo_disj_fr_pl, axiom, disjoint(france,poland)).
fof(geo_disj_fr_pl_sym, axiom, disjoint(poland,france)).
fof(geo_disj_fr_cz, axiom, disjoint(france,czechia)).
fof(geo_disj_fr_cz_sym, axiom, disjoint(czechia,france)).
fof(geo_disj_it_pl, axiom, disjoint(italy,poland)).
fof(geo_disj_it_pl_sym, axiom, disjoint(poland,italy)).
fof(geo_disj_it_cz, axiom, disjoint(italy,czechia)).
fof(geo_disj_it_cz_sym, axiom, disjoint(czechia,italy)).
fof(geo_disj_be_pl, axiom, disjoint(belgium,poland)).
fof(geo_disj_be_pl_sym, axiom, disjoint(poland,belgium)).
fof(geo_disj_be_cz, axiom, disjoint(belgium,czechia)).
fof(geo_disj_be_cz_sym, axiom, disjoint(czechia,belgium)).
fof(geo_disj_nl_pl, axiom, disjoint(netherlands,poland)).
fof(geo_disj_nl_pl_sym, axiom, disjoint(poland,netherlands)).
fof(geo_disj_nl_cz, axiom, disjoint(netherlands,czechia)).
fof(geo_disj_nl_cz_sym, axiom, disjoint(czechia,netherlands)).
fof(geo_disj_es_pl, axiom, disjoint(spain,poland)).
fof(geo_disj_es_pl_sym, axiom, disjoint(poland,spain)).
fof(geo_disj_es_cz, axiom, disjoint(spain,czechia)).
fof(geo_disj_es_cz_sym, axiom, disjoint(czechia,spain)).
fof(geo_disj_bav_fr, axiom, disjoint(bavaria,france)).
fof(geo_disj_bav_fr_sym, axiom, disjoint(france,bavaria)).
fof(geo_disj_bav_pl, axiom, disjoint(bavaria,poland)).
fof(geo_disj_bav_pl_sym, axiom, disjoint(poland,bavaria)).
fof(geo_disj_bav_it, axiom, disjoint(bavaria,italy)).
fof(geo_disj_bav_it_sym, axiom, disjoint(italy,bavaria)).
% ─── Conjecture ─────────────────────────────────────────────────────────────
fof(e4_c1_09, conjecture, ?[X]: (in_denotation(X,germany,isPartOf) & in_denotation(X,westernEurope,isPartOf) & in_denotation(X,europe,isPartOf))).
%--------------------------------------------------------------------------
