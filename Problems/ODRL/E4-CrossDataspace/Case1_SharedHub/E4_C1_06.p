...
% Policy pair: Permit location=germany vs Permit location=westernEurope
% Note: compat: de≤wE — subsumption witness
...
% ─── Conjecture ─────────────────────────────────────────────────────────────
fof(e4_c1_06, conjecture, ?[X]: (in_denotation(X,germany,isPartOf) & in_denotation(X,westernEurope,isPartOf))).
%--------------------------------------------------------------------------
