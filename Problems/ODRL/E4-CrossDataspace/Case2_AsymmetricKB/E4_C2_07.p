...
% Policy pair: Provider: Permit location=belgium / Consumer: Prohibit location=spain
% Note: FP-RISK: be⊥es in KB_A only; KB_B: both≤wE, no sibling disj
...
% ─── Conjecture ─────────────────────────────────────────────────────────────
fof(e4_c2_07, conjecture, ![X]: ~(in_denotation(X,belgium,isPartOf) & in_denotation(X,spain,isPartOf))).
%--------------------------------------------------------------------------
