...
% Policy pair: Provider: Permit location=germany / Consumer: Prohibit location=poland
% Note: TRUE-CONFLICT KB_B: de≤wE, pl≤eE, root wE⊥eE sufficient
...
% ─── Conjecture ─────────────────────────────────────────────────────────────
fof(e4_c2_01, conjecture, ![X]: ~(in_denotation(X,germany,isPartOf) & in_denotation(X,poland,isPartOf))).
%--------------------------------------------------------------------------
