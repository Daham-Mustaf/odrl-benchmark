...
% Policy pair: Provider: Permit location=france / Consumer: Prohibit location=czechia
% Note: TRUE-CONFLICT KB_B: fr≤wE, cz≤eE, root wE⊥eE
...
% ─── Conjecture ─────────────────────────────────────────────────────────────
fof(e4_c2_03, conjecture, ![X]: ~(in_denotation(X,france,isPartOf) & in_denotation(X,czechia,isPartOf))).
%--------------------------------------------------------------------------
