...
% Policy pair: Provider: Permit location=bavaria / Consumer: Prohibit location=poland
% Note: TRUE-CONFLICT KB_B: bav≤de≤wE, pl≤eE, root wW⊥eE
...
% ─── Conjecture ─────────────────────────────────────────────────────────────
fof(e4_c2_04, conjecture, ![X]: ~(in_denotation(X,bavaria,isPartOf) & in_denotation(X,poland,isPartOf))).
%--------------------------------------------------------------------------
