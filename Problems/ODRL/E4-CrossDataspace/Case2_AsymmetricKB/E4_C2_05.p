...
% Policy pair: Provider: Permit location=italy / Consumer: Prohibit location=easternEurope
% Note: TRUE-CONFLICT KB_B: it≤wE, root wE⊥eE
...
% ─── Conjecture ─────────────────────────────────────────────────────────────
fof(e4_c2_05, conjecture, ![X]: ~(in_denotation(X,italy,isPartOf) & in_denotation(X,easternEurope,isPartOf))).
%--------------------------------------------------------------------------
