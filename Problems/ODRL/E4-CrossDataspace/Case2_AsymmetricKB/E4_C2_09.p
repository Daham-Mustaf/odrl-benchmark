...
% Policy pair: Provider: Permit location=bavaria / Consumer: Prohibit location=france
% Note: FP-RISK: bav⊥fr in KB_A only (bav≤de, de⊥fr); KB_B: no de⊥fr
...
% ─── Conjecture ─────────────────────────────────────────────────────────────
fof(e4_c2_09, conjecture, ![X]: ~(in_denotation(X,bavaria,isPartOf) & in_denotation(X,france,isPartOf))).
%--------------------------------------------------------------------------
