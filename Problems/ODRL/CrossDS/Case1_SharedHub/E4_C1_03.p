...
% Policy pair: Permit location=germany vs Prohibit location=poland
% Note: D2-derived: de≤wE, pl≤eE, wE⊥eE
...
% ─── Conjecture ─────────────────────────────────────────────────────────────
fof(e4_c1_03, conjecture, ![X]: ~(in_denotation(X,germany,isPartOf) & in_denotation(X,poland,isPartOf))).
%--------------------------------------------------------------------------
