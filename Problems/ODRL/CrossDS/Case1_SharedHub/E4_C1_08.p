...
% Policy pair: Provider allows germany ⊆ consumer requires westernEurope
% Note: compat: universal subsumption de⊆wE
...
% ─── Conjecture ─────────────────────────────────────────────────────────────
fof(e4_c1_08, conjecture, ![X]: (in_denotation(X,germany,isPartOf) => in_denotation(X,westernEurope,isPartOf))).
%--------------------------------------------------------------------------
