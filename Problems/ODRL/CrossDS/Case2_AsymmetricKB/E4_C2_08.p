...
% Policy pair: Provider: Permit location=poland / Consumer: Prohibit location=czechia
% Note: FP-RISK: pl⊥cz in KB_A only; KB_B: both≤eE, no sibling disj
...
% ─── Conjecture ─────────────────────────────────────────────────────────────
fof(e4_c2_08, conjecture, ![X]: ~(in_denotation(X,poland,isPartOf) & in_denotation(X,czechia,isPartOf))).
%--------------------------------------------------------------------------
