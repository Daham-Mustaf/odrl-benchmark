...
% Policy pair: Provider: Permit location=netherlands / Consumer: Prohibit location=spain
% Note: FP-RISK: nl⊥es in KB_A only; KB_B: both≤wE, no sibling disj
...
% ─── Conjecture ─────────────────────────────────────────────────────────────
fof(e4_c2_10, conjecture, ![X]: ~(in_denotation(X,netherlands,isPartOf) & in_denotation(X,spain,isPartOf))).
%--------------------------------------------------------------------------
