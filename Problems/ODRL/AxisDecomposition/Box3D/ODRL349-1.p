%--------------------------------------------------------------------------
% File     : ODRL349-1 : TPTP v0.2.0
% Domain   : ODRL Spatial Axis Profile
% Problem  : All 3 axes: box A ⊆ box B → Subsumes
% Expected : Theorem
% Verdict  : Subsumes
% Category : Box3D
% Difficulty: Medium
...
fof(odrl349, conjecture,
    ![X,Y,Z]: ((in_lopen(X, v0, v600) & in_lopen(Y, v0, v400) & in_lopen(Z, v0, v16)) => (in_lopen(X, v0, v1200) & in_lopen(Y, v0, v800) & in_lopen(Z, v0, v32)))).
%--------------------------------------------------------------------------
