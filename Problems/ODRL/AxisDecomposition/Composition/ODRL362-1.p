...
% Problem  : 4th axis conflict × 3 compatible → box Conflict
% Version  : 1.0
% English  : Width/Height/Depth: all compatible
...
%           : Policy source: Policies/ODRL362-policy.ttl
%--------------------------------------------------------------------------
