%--------------------------------------------------------------------------
% File     : ODRL463-1 : TPTP v0.2.0
% Domain   : ODRL Spatial Axis Profile
% Problem  : AND(A)×XONE(B): A in XONE both-hold zone → Conflict
% Expected : Theorem
% Verdict  : Conflict
...
%            (0, 400] ∩ (0, 600] ∅  →  Conflict
% Notes    : A: w≤400, h≤200 → B-XONE: w≤600 ✓, h≤400 ✓ → both hold → XONE=false. Symmetric to ODRL461.
