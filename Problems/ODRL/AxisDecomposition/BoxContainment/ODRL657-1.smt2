...
; Axioms   : 4-axis box: absent width axis propagates Unknown
; Version  : 1.0
; Authors  : Mustafa, D. & Sutcliffe, G.
; Refs     : [Mus+26b] Mustafa, D., et al. Axis Decomposition for ODRL: Resolving Dimensional Ambiguity in Policy Constraints through Interval Semantics. ISWC 2026 (submitted).
; Source   : Mustafa, D. (2026)
; Names    : ODRL657-1.smt2
; Status   : unsat
; Comments : Verdict: Unknown  Category: BoxContainment  Difficulty: Medium
; --------------------------------------------------------------------------
...
; axis_subsumes ground hints for the 3 present axes
