...
; Axioms   : 4-axis box containment: all axes A subsumed-by B -> Compatible
; Version  : 1.0
; Authors  : Mustafa, D. & Sutcliffe, G.
; Refs     : [Mus+26b] Mustafa, D., et al. Axis Decomposition for ODRL: Resolving Dimensional Ambiguity in Policy Constraints through Interval Semantics. ISWC 2026 (submitted).
; Source   : Mustafa, D. (2026)
; Names    : ODRL652-1.smt2
; Status   : unsat
; Comments : Verdict: Compatible  Category: BoxContainment  Difficulty: Medium
; --------------------------------------------------------------------------
...
; axis_subsumes ground hints (positive on all 4 axes)
