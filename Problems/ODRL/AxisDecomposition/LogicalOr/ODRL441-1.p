...
% Problem  : All PolicyA or-branches conflict with PolicyB → Conflict
% Version  : 1.0
% English  : PolicyA: width lteq 400 OR height lteq 100 (odrl:or)
...
%           : Policy source: Policies/ODRL441-policy.ttl
%--------------------------------------------------------------------------
