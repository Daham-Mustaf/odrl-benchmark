%--------------------------------------------------------------------------
% File     : ODRL441-1 : TPTP v0.2.0
% Domain   : ODRL Spatial Axis Profile
% Problem  : OR(A)×AND(B): both OR-arms fail → Conflict
% Expected : Theorem
% Verdict  : Conflict
% Category : LogicalOr
% Difficulty: Medium
...
%            width gteq 800  →  [800, ∞)
%            (0, 400] ∩ [800, ∞) ∅  →  Conflict
% Notes    : Width arm: ≤400 ∩ ≥800 = ∅. Height arm: ≤100 ∩ ≥200 = ∅. Every OR-disjunct individually conflicts with B's AND.
