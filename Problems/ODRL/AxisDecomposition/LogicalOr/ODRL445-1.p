...
% Problem  : 3-branch or: all branch pairs conflict → Conflict
% Version  : 1.0
% English  : PolicyA: width lteq 200 OR height lteq 100 OR depth lteq 50 (odrl:or)
...
%           : Policy source: Policies/ODRL445-policy.ttl
%--------------------------------------------------------------------------
