%--------------------------------------------------------------------------
% File     : ODRL387-1 : TPTP v0.2.0
% Domain   : ODRL Spatial Axis Profile
% Problem  : Spatial + temporal: tighter box subsumes wider
% Expected : Theorem
% Verdict  : Subsumes
...
% ─── Conjecture ──────────────────────────────────────────────────────
fof(odrl387, conjecture,
    ![X,Y]: ((in_lopen(X, v0, v600) & in_closed(Y, v0, v181)) => (in_lopen(X, v0, v1200) & in_closed(Y, v0, v365)))).
%--------------------------------------------------------------------------
