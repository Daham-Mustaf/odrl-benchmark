...
; ============================================================================
; Source:     test_03_contradictory_equality_conflict.ttl
; Policy:     http://example.org/policy_delay_period_03
; Rule:       rule_1
...
(assert
 (and (= 2592000.0 delayPeriod_default_default) (= 5184000.0 delayPeriod_default_default)))
(assert
