...
; ============================================================================
; Source:     test_11_valid_delay_window.ttl
; Policy:     http://example.org/policy_delay_period_11
; Rule:       rule_1
...
(assert
 (and (<= 604800.0 delayPeriod_default_default) (>= 2592000.0 delayPeriod_default_default)))
(assert
