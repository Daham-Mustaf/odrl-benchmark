...
; Policy:     http://example.org/policy_delay_period_20
; Rule:       rule_1
...
(assert
 (let (($x6 (and (<= 604800.0 delayPeriod_default_default) (>= 2592000.0 delayPeriod_default_default))))
 (and (or $x6 (<= 7776000.0 delayPeriod_default_default)) (>= 31536000.0 delayPeriod_default_default))))
(assert
