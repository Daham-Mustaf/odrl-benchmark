...
; ============================================================================
; Source:     test_01_impossible_delay_range_conflict.ttl
; Policy:     http://example.org/policy_delay_period_01
; Rule:       rule_1
...
(assert
 (and (<= 3600.0 delayPeriod_default_default) (>= 1800.0 delayPeriod_default_default)))
(assert
