...
; ============================================================================
; Source:     13_isAnyOf_compatible_range.ttl
...
(assert
 (let (($x12 (or (= 25.0 payAmount_EUR_default) (= 50.0 payAmount_EUR_default) (= 75.0 payAmount_EUR_default) (= 100.0 payAmount_EUR_default))))
 (and $x12 (<= 50.0 payAmount_EUR_default) (>= 100.0 payAmount_EUR_default))))
(assert
