...
; Policy:     http://example.org/policy_elapsed_time_05
; Rule:       rule_1
...
(assert
 (let (($x12 (or (= 3600.0 elapsedTime_default_default) (= 7200.0 elapsedTime_default_default) (= 10800.0 elapsedTime_default_default))))
 (and $x12 (> 1800.0 elapsedTime_default_default))))
(assert
