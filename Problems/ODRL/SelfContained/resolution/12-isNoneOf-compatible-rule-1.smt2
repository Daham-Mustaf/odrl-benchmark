...
; ============================================================================
; Source:     12_isNoneOf_compatible.ttl
...
(assert
 (let (($x15 (and (and (distinct 72.0 resolution_DPI_default) true) (and (distinct 150.0 resolution_DPI_default) true))))
 (and $x15 (= 300.0 resolution_DPI_default))))
(assert
