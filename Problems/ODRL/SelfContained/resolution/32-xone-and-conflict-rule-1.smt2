...
; ============================================================================
; Source:     32_xone_and_conflict.ttl
...
(assert
 (let (($x37 (<= 600.0 resolution_DPI_default)))
 (let (($x71 (>= 150.0 resolution_DPI_default)))
 (and (and (or $x71 $x37) (and (not (and $x71 $x37)))) (= 300.0 resolution_DPI_default)))))
(assert
