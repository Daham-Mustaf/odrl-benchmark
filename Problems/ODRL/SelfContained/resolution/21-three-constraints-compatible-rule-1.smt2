...
; ============================================================================
; Source:     21_three_constraints_compatible.ttl
...
(assert
 (and (<= 150.0 resolution_DPI_default) (>= 600.0 resolution_DPI_default) (and (distinct 300.0 resolution_DPI_default) true)))
(assert
