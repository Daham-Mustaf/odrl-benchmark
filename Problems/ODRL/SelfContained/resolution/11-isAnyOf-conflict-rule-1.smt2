...
; ============================================================================
; Source:     11_isAnyOf_conflict.ttl
...
(assert
 (let (($x44 (or (= 72.0 resolution_DPI_default) (= 150.0 resolution_DPI_default) (= 300.0 resolution_DPI_default))))
 (and $x44 (< 600.0 resolution_DPI_default))))
(assert
