...
; ============================================================================
; Source:     13_isNoneOf_conflict.ttl
...
(assert
 (let (($x32 (= 300.0 resolution_DPI_default)))
 (let (($x62 (and (and (distinct 72.0 resolution_DPI_default) true) (and (distinct 150.0 resolution_DPI_default) true) (and (distinct 300.0 resolution_DPI_default) true))))
 (and $x62 $x32))))
(assert
