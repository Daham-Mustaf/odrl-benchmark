...
; ============================================================================
; Source:     10_isAnyOf_compatible.ttl
...
(assert
 (let (($x41 (or (= 72.0 resolution_DPI_default) (= 150.0 resolution_DPI_default) (= 300.0 resolution_DPI_default) (= 600.0 resolution_DPI_default))))
 (and $x41 (<= 300.0 resolution_DPI_default))))
(assert
