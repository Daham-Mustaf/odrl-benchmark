%--------------------------------------------------------------------------
% File     : GEO_M05_full.p : TPTP v0.1.0.
...
% GEO disjointness: 32/32 kept (0% removed)
...
% ─── Conjecture ──────────────────────────────────────────────────────────
fof(geo_m05, conjecture, ?[X]: (in_denotation(X,germany,isPartOf) & in_denotation(X,westernEurope,isPartOf) & in_denotation(X,europe,isPartOf))).
