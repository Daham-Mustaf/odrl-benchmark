...
; Names    : GRND024-obl-proh-coexist-1.smt2
; Status   : sat
; Comments : obl(obl1) activated at e1: creates Duty(bibliothek, read, theater_ds).
...
;            Policy source: Policies/GRND024-obl-proh-coexist-policy.ttl
