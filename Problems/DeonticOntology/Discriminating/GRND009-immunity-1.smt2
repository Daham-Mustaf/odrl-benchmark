...
; Axioms   : Strong permission: Permission persists (Disability blocks prohibition)
; Version  : 1.6
...
; Names    : GRND009-immunity-1.smt2
; Status   : unsat
; Comments : H2 = {Permission, NoRight, Immunity, Disability}.
