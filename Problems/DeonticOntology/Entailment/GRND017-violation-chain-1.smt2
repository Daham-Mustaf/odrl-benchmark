...
; Axioms   : A1-A3+B1: violation triggers norm state change requiring Power
; Version  : 1.6
...
; Names    : GRND017-violation-chain-1.smt2
; Status   : unsat
; Comments : proh(f1) + has_rem(f1) + does(marketplace,distrib,concert_ds).
...
;            Policy source: Policies/GRND017-violation-chain-policy.ttl
