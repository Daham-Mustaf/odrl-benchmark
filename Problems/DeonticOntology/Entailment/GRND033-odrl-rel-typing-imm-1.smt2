...
; Names    : GRND033-odrl-rel-typing-imm-1.smt2
; Status   : unsat
; Comments : founds_imm(e1,rho1,p1) & perm(p1) => odrl_rel(rho1).
;            Ax5.7 immunity variant tested in isolation.
;            Foundational ontology tier. FOIS 2026 benchmark.
;            Policy source: Policies/GRND033-odrl-rel-typing-imm-policy.ttl
