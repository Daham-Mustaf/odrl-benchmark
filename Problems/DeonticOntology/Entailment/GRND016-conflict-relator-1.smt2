...
; Axioms   : Conflict detection: Permission and Duty in same relator
; Version  : 1.6
...
; Names    : GRND016-conflict-relator-1.smt2
; Status   : unsat
; Comments : Permission(l) and Duty(d) both partOf rho1, same bearer, same content.
...
;            Policy source: Policies/GRND016-conflict-relator-policy.ttl
