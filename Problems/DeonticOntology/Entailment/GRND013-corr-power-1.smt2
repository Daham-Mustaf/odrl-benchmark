...
; Axioms   : Correlativity: Power implies unique Subjection in relator
; Version  : 1.6
...
; Names    : GRND013-corr-power-1.smt2
; Status   : unsat
; Comments : odrl_rel(rho1), Power(pw) partOf rho1 => exists unique s. Subjection(s) partOf rho1.
