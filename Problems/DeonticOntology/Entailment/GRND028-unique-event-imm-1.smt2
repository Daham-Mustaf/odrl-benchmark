...
; Axioms   : Unique event imm: same relator+rule founded by at most one event
; Version  : 1.6
...
; Names    : GRND028-unique-event-imm-1.smt2
; Status   : unsat
; Comments : founds_imm(e1,rho1,p1) and founds_imm(e2,rho1,p1) => e1 = e2.
;            UFO uniqueness (event side) for immunity relator.
;            Foundational ontology tier. FOIS 2026 benchmark.
;            Policy source: Policies/GRND028-unique-event-imm-policy.ttl
