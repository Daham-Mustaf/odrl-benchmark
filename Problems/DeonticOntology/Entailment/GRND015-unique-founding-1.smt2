...
; Axioms   : Unique founding: same event+rule founds at most one relator
; Version  : 1.6
...
; Names    : GRND015-unique-founding-1.smt2
; Status   : unsat
; Comments : founds(e1,rho1,p1) and founds(e1,rho2,p1) => rho1 = rho2.
