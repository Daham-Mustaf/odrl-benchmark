...
; Axioms   : Unique founding imm: same event+rule founds at most one immunity relator
; Version  : 1.6
...
; Names    : GRND026-unique-founding-imm-1.smt2
; Status   : unsat
; Comments : founds_imm(e1,rho1,p1) and founds_imm(e1,rho2,p1) => rho1 = rho2.
;            UFO uniqueness for immunity relator — mirrors GRND015 for founds_imm.
;            Foundational ontology tier. FOIS 2026 benchmark.
;            Policy source: Policies/GRND026-unique-founding-imm-policy.ttl
